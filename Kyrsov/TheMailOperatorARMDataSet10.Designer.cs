...
SELECT id, post_office_address, fio_sender, phone_sender, address_sender, fio_recipient, phone_recipient, address_recipient, length, width, height, weight, parcel_contents, price, status, random_password, type_of_departure, payment, region, apartment, apartment_nubmer, street, city, dispatch_time FROM Applications WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Applications] SET [post_office_address] = @post_office_address, [fi" +
                ...
                "@street, [city] = @city, [dispatch_time] = @dispatch_time WHERE (([id] = @Origin" +
                "al_id) AND ((@IsNull_post_office_address = 1 AND [post_office_address] IS NULL) " +
                "OR ([post_office_address] = @Original_post_office_address)) AND ((@IsNull_fio_se" +
                "nder = 1 AND [fio_sender] IS NULL) OR ([fio_sender] = @Original_fio_sender)) AND" +
                " ((@IsNull_phone_sender = 1 AND [phone_sender] IS NULL) OR ([phone_sender] = @Or" +
                "iginal_phone_sender)) AND ((@IsNull_address_sender = 1 AND [address_sender] IS N" +
                "ULL) OR ([address_sender] = @Original_address_sender)) AND ((@IsNull_fio_recipie" +
                "nt = 1 AND [fio_recipient] IS NULL) OR ([fio_recipient] = @Original_fio_recipien" +
                "t)) AND ((@IsNull_phone_recipient = 1 AND [phone_recipient] IS NULL) OR ([phone_" +
                "recipient] = @Original_phone_recipient)) AND ((@IsNull_address_recipient = 1 AND" +
                " [address_recipient] IS NULL) OR ([address_recipient] = @Original_address_recipi" +
                "ent)) AND ((@IsNull_length = 1 AND [length] IS NULL) OR ([length] = @Original_le" +
                "ngth)) AND ((@IsNull_width = 1 AND [width] IS NULL) OR ([width] = @Original_widt" +
                ...
                "ght)) AND ((@IsNull_parcel_contents = 1 AND [parcel_contents] IS NULL) OR ([parc" +
                "el_contents] = @Original_parcel_contents)) AND ((@IsNull_price = 1 AND [price] I" +
                "S NULL) OR ([price] = @Original_price)) AND ((@IsNull_status = 1 AND [status] IS" +
                " NULL) OR ([status] = @Original_status)) AND ((@IsNull_random_password = 1 AND [" +
                "random_password] IS NULL) OR ([random_password] = @Original_random_password)) AN" +
                "D ((@IsNull_type_of_departure = 1 AND [type_of_departure] IS NULL) OR ([type_of_" +
                "departure] = @Original_type_of_departure)) AND ((@IsNull_payment = 1 AND [paymen" +
                "t] IS NULL) OR ([payment] = @Original_payment)) AND ((@IsNull_region = 1 AND [re" +
                "gion] IS NULL) OR ([region] = @Original_region)) AND ((@IsNull_apartment = 1 AND" +
                " [apartment] IS NULL) OR ([apartment] = @Original_apartment)) AND ((@IsNull_apar" +
                "tment_nubmer = 1 AND [apartment_nubmer] IS NULL) OR ([apartment_nubmer] = @Origi" +
                "nal_apartment_nubmer)) AND ((@IsNull_street = 1 AND [street] IS NULL) OR ([stree" +
                ...
                " ([dispatch_time] = @Original_dispatch_time)));\r\nSELECT id, post_office_address," +
                " fio_sender, phone_sender, address_sender, fio_recipient, phone_recipient, addre" +
                "ss_recipient, length, width, height, weight, parcel_contents, price, status, ran" +
                "dom_password, type_of_departure, payment, region, apartment, apartment_nubmer, s" +
                "treet, city, dispatch_time FROM Applications WHERE (id = @id)";
        ...
        public virtual int Fill(TheMailOperatorARMDataSet10.ApplicationsDataTable dataTable) {
        ...
        public virtual TheMailOperatorARMDataSet10.ApplicationsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TheMailOperatorARMDataSet10.ApplicationsDataTable dataTable = new TheMailOperatorARMDataSet10.ApplicationsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TheMailOperatorARMDataSet10.ApplicationsDataTable dataTable) {
