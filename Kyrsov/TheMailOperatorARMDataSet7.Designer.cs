    ...
    public partial class TheMailOperatorARMDataSet7 : global::System.Data.DataSet {
        ...
        public partial class ApplicationsRow : global::System.Data.DataRow {
            ...
            public System.DateTime date_time {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tableApplications.date_timeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'date_time\' в таблице \'Applications\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableApplications.date_timeColumn] = value;
                }
            }
            ...
            public bool Isdate_timeNull() {
                return this.IsNull(this.tableApplications.date_timeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void Setdate_timeNull() {
                this[this.tableApplications.date_timeColumn] = global::System.Convert.DBNull;
            }
        }
    ...
    public partial class ApplicationsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Applications] WHERE (([id] = @Original_id) AND ((@IsNull_id_Em" +
                ...
                "] IS NULL) OR ([random_password] = @Original_random_password)) AND ((@IsNull_dat" +
                "e_time = 1 AND [date_time] IS NULL) OR ([date_time] = @Original_date_time)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Applications] ([id_Employs], [post_office_address], [fio_sender], [phone_sender], [address_sender], [fio_recipient], [phone_recipient], [address_recipient], [size], [weight], [parcel_contents], [price], [status], [random_password], [date_time]) VALUES (@id_Employs, @post_office_address, @fio_sender, @phone_sender, @address_sender, @fio_recipient, @phone_recipient, @address_recipient, @size, @weight, @parcel_contents, @price, @status, @random_password, @date_time);
SELECT id, id_Employs, post_office_address, fio_sender, phone_sender, address_sender, fio_recipient, phone_recipient, address_recipient, size, weight, parcel_contents, price, status, random_password, date_time FROM Applications WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Applications] SET [id_Employs] = @id_Employs, [post_office_address]" +
                ...
                "price, [status] = @status, [random_password] = @random_password, [date_time] = @" +
                "date_time WHERE (([id] = @Original_id) AND ((@IsNull_id_Employs = 1 AND [id_Empl" +
                "oys] IS NULL) OR ([id_Employs] = @Original_id_Employs)) AND ((@IsNull_post_offic" +
                ...
                "R ([address_recipient] = @Original_address_recipient)) AND ((@IsNull_size = 1 AN" +
                "D [size] IS NULL) OR ([size] = @Original_size)) AND ((@IsNull_weight = 1 AND [we" +
                "ight] IS NULL) OR ([weight] = @Original_weight)) AND ((@IsNull_parcel_contents =" +
                " 1 AND [parcel_contents] IS NULL) OR ([parcel_contents] = @Original_parcel_conte" +
                "nts)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price" +
                ")) AND ((@IsNull_status = 1 AND [status] IS NULL) OR ([status] = @Original_statu" +
                "s)) AND ((@IsNull_random_password = 1 AND [random_password] IS NULL) OR ([random" +
                "_password] = @Original_random_password)) AND ((@IsNull_date_time = 1 AND [date_t" +
                "ime] IS NULL) OR ([date_time] = @Original_date_time)));\r\nSELECT id, id_Employs, " +
                "post_office_address, fio_sender, phone_sender, address_sender, fio_recipient, ph" +
                "one_recipient, address_recipient, size, weight, parcel_contents, price, status, " +
                "random_password, date_time FROM Applications WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, id_Employs, post_office_address, fio_sender, phone_sender, address_sen" +
                ...
                "tents, price, status, random_password, date_time FROM dbo.Applications";
        ...
        public virtual int Delete(
            ...
            if ((Original_date_time.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[30].Value = ((System.DateTime)(Original_date_time.Value));
            }
            else {
        ...
        public virtual int Insert(global::System.Nullable<int> id_Employs, string post_office_address, string fio_sender, string phone_sender, string address_sender, string fio_recipient, string phone_recipient, string address_recipient, string size, string weight, string parcel_contents, global::System.Nullable<decimal> price, string status, string random_password, global::System.Nullable<global::System.DateTime> date_time) {
            ...
            if ((date_time.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[14].Value = ((System.DateTime)(date_time.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((date_time.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[14].Value = ((System.DateTime)(date_time.Value));
            }
            else {
            ...
            if ((Original_date_time.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[45].Value = ((System.DateTime)(Original_date_time.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_random_password, 
                    global::System.Nullable<global::System.DateTime> Original_date_time) {
            return this.Update(id_Employs, post_office_address, fio_sender, phone_sender, address_sender, fio_recipient, phone_recipient, address_recipient, size, weight, parcel_contents, price, status, random_password, date_time, Original_id, Original_id_Employs, Original_post_office_address, Original_fio_sender, Original_phone_sender, Original_address_sender, Original_fio_recipient, Original_phone_recipient, Original_address_recipient, Original_size, Original_weight, Original_parcel_contents, Original_price, Original_status, Original_random_password, Original_date_time, Original_id);
        }
    }
